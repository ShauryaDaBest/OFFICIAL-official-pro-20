...
function draw() {
    ...
    { 
     //When we switch between animations we use label names
     //When we switch between images we use variable names
     //When you're adding animation variable and label name both must be used
